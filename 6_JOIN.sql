...
SELECT DISTINCT matchid,mdate, COUNT(player)
  FROM game JOIN goal ON matchid = id 
...
SELECT mdate, 
  team1, SUM(CASE WHEN teamid=team1 THEN 1 ELSE 0 END) as score1, team2, SUM(CASE WHEN teamid=team2 THEN 1 ELSE 0 END) as score2
